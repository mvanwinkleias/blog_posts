# ias_actually_detatch_from_pdf

pdfdetach might not like to detatch files with slashes in the name
...
* ```src/bin/ias-actually-detatch-from-pdf_hello.sh``` - does something
...
* /opt/IAS/bin/ias-actually-detatch-from-pdf/
