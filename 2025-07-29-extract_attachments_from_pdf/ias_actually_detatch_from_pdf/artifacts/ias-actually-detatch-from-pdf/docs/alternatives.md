...
update-alternatives --install \
	/usr/bin/ias-actually-detatch-from-pdf_hello \
	ias-actually-detatch-from-pdf_hello \
	/opt/IAS/bin/ias-actually-detatch-from-pdf/ias-actually-detatch-from-pdf_hello.sh 50
```
...
update-alternatives --remove \
	ias-actually-detatch-from-pdf_hello \
	/opt/IAS/bin/ias-actually-detatch-from-pdf/ias-actually-detatch-from-pdf_hello.sh
```
