...
setup_args = {
    'name' : "mv-diy-pip-repo-mvanwinkleias", # Replace with your own username
    'version' : "0.0.1",
    'author' : "Martin VanWinkle III",
    'author_email' : "mvanwinkle@ias.edu",
    'description' : "Copies a .tar.gz pip to a proper subdirectory",
    'long_description' : long_description,
    'long_description_content_type' : "text/markdown",
    'url' : "https://example.com/pypa/sampleproject",
