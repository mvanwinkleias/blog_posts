...
update-alternatives --install \
	/usr/bin/ias-bitwarden-installer_hello \
	ias-bitwarden-installer_hello \
	/opt/IAS/bin/ias-bitwarden-installer/ias-bitwarden-installer_hello.sh 50
```
...
update-alternatives --remove \
	ias-bitwarden-installer_hello \
	/opt/IAS/bin/ias-bitwarden-installer/ias-bitwarden-installer_hello.sh
```
