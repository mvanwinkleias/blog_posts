...
update-alternatives --install \
	/usr/bin/mv-disable-ubuntu-annoyances_hello \
	mv-disable-ubuntu-annoyances_hello \
	/opt/IAS/bin/mv-disable-ubuntu-annoyances/mv-disable-ubuntu-annoyances_hello.sh 50
```
...
update-alternatives --remove \
	mv-disable-ubuntu-annoyances_hello \
	/opt/IAS/bin/mv-disable-ubuntu-annoyances/mv-disable-ubuntu-annoyances_hello.sh
```
